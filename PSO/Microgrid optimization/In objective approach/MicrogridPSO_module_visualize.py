...
class PSO_plot:
    ...
    def __init__(self):
        ...
        print('figplot(x,y,x_name,y_name,title,size1,size2,fontsize,grid,y_range,subplot1,subplot2,subplot3)')
        print('figplot(x,y1,y2,x_name,y1_name,y2_name,title,size1,size2,fontsize,y_range,subplot1,subplot2,subplot3)')        
        print(vars(self))
    ...
    def figplot(self,x,y,x_name,y_name,title,size1,size2,fontsize,y_range,subplot1,subplot2,subplot3):
    ...
    def figplot2(self,x,y1,y2,x_name,y1_name,y2_name,title,size1,size2,fontsize,y_range,subplot1,subplot2,subplot3):
